                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Predictions Listing</h4>
                            <a href="/admin/prediction/create">
                                <button type="button" class="btn btn-primary w-md m-b-5">Add a new Prediction</button>
                            </a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="products" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                @foreach($predictions as $single)
                                    <tr>
                                        <td>{{$single->title}}</td>
                                        <td>{{$single->created_at->toFormattedDateString()}}</td>
                                        <td>
                                            <a href="/admin/prediction/{{$single->id}}/edit">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('.delete').click(function(){
                ...
                swal({
                        title: "Are you sure?",
                        text: "Do you want to delete this prediction?",
                        type: "warning",
                            ...
                            success: function(resp){
                                if(resp.success) {
                                    setTimeout(function () {
                                        ...
                                        toastr.success('Prediction deleted successfully.');
                                    }, 1300);
                                    setTimeout(function () {
                                        $("."+id).fadeOut();
                                    }, 1600);
