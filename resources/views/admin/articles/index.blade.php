                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Article Listing</h4>
                            <a href="/admin/articles/create">
                                <button type="button" class="btn btn-primary w-md m-b-5">Add a Article</button>
                            </a>
                        </div>
                    </div>
                            ...
                            <table id="products" class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($articles as $single)
                                    <tr class="{{$single->id}}">
                                        ...
                                        <td>{{$single->media_type}}</td>
                                        <td>{{$single->created_at->toFormattedDateString()}}</td>
                                        <td>
                                            <a href="/admin/articles/{{$single->id}}/edit">
