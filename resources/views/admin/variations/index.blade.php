                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Variations Listing</h4>
                            <a href="/admin/variations/create">
                                <button type="button" class="btn btn-primary w-md m-b-5">Add a new variation</button>
                            </a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="variations" class="table table-bordered table-striped table-hover">
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Created on</th>
                                ...
                                @foreach($variations as $variation)
                                    <tr>
                                        ...
                                        <td>{{$variation->created_at->toFormattedDateString()}}</td>
                                        <td>
                                            <a href="/admin/variations/{{$variation->id}}/edit">
