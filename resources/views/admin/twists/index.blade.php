                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Twists Listing</h4>
                            <a href="/admin/twists/create">
                                <button type="button" class="btn btn-primary w-md m-b-5">Add a new Twist</button>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="subCategory" class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($twists as $twist)
                                    <tr>
                                        <td>{{$twist->question}}</td>
                                        <td>{{$twist->episode}}</td>
                                        <td>{{$twist->created_at->toFormattedDateString()}}</td>
                                        <td>
                                            <a href="/admin/twists/{{$twist->id}}/edit">
