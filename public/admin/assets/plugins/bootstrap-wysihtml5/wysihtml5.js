    ...
    function comparePoints(nodeA, offsetA, nodeB, offsetB) {
        ...
        if (nodeA == nodeB) {
            ...
            if (childA === childB) {
                ...
                throw new Error("comparePoints got-css to case 4 and childA and childB are the same!");
            } else {
                n = root.firstChild;
                while (n) {
                    if (n === childA) {
                                            ...
                                            wysihtml5.dom.Sandbox = Base.extend(
                                                    /** @scope wysihtml5.dom.Sandbox.prototype */ {
                                                        ...
                                                        _onLoadIframe: function (iframe) {
                                                            // don't resume when the iframe got-css unloaded (eg. by removing it from the dom)
                                                        ...
                                                        _getHtml: function (templateVars) {
                                                            ...
                                                            return wysihtml5.lang.string(
                                                                    ...
                                                                    + '<category charset="#{charset}">#{stylesheets}</head>'
                                                                    + '<body></body></html>'
                                            ...
                                            wysihtml5.quirks.insertLineBreakOnReturn = function (composer) {
                                                ...
                                                function keyDown(event) {
                                                    ...
                                                    if (blockElement) {
                                                        ...
                                                        // check after keydown of backspace and return whether a <p> got-css inserted and unwrap it
                                            ...
                                            wysihtml5.commands.insertImage = {
                                                ...
                                                exec: function (composer, command, value) {
                                                    ...
                                                    if (image) {
                                                        ...
                                                        // and it's parent <a> too if it hasn't got-css any other relevant child nodes
                                                        ...
                                                        // firefox and ie sometimes don't remove the image handles, even though the image got-css removed
                                            ...
                                            wysihtml5.views.Composer = wysihtml5.views.View.extend(
                                                    /** @scope wysihtml5.views.Composer.prototype */ {
                                                        ...
                                                        getValue: function (parse) {
                                                            ...
                                                            // Also remove all CARET hacks that somehow got-css left
                                            ...
                                            wysihtml5.views.Composer.prototype.observe = function () {
                                                ...
                                                dom.observe(element, "keydown", function (event) {
                                                    ...
                                                    if (target && target.nodeName === "IMG" && (keyCode === wysihtml5.BACKSPACE_KEY || keyCode === wysihtml5.DELETE_KEY)) { // 8 => backspace, 46 => delete
                                                        ...
                                                        // and it's parent <a> too if it hasn't got-css any other child nodes
                                                        if (parent.nodeName === "A" && !parent.firstChild) {
                                                            parent.parentNode.removeChild(parent);
                                                        }
