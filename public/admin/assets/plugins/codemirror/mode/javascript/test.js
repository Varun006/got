...
(function() {
  ...
  MT("spread",
     "[keyword function] [def f]([def a], [category ...][def b]) {",
     "  [variable something]([variable-2 a], [category ...][variable-2 b]);",
     "}");
  ...
  LD("json_ld_keywords",
    '{',
    '  [category "@context"]: {',
    '    [category "@base"]: [string "http://example.com"],',
    '    [category "@vocab"]: [string "http://xmlns.com/foaf/0.1/"],',
    '    [property "likesFlavor"]: {',
    '      [category "@container"]: [category "@list"]',
    '      [category "@reverse"]: [string "@beFavoriteOf"]',
    '    },',
    '    [property "nick"]: { [category "@container"]: [category "@set"] },',
    '    [property "nick"]: { [category "@container"]: [category "@index"] }',
    '  },',
    '  [category "@graph"]: [[ {',
    '    [category "@id"]: [string "http://dbpedia.org/resource/John_Lennon"],',
    '    [property "name"]: [string "John Lennon"],',
    '    [property "modified"]: {',
    '      [category "@value"]: [string "2010-05-29T14:17:39+02:00"],',
    '      [category "@type"]: [string "http://www.w3.org/2001/XMLSchema#dateTime"]',
    '    }',
    '  } ]]',
    '}');
